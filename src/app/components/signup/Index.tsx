...
const SignUp = (props: any) => {
  ...
  function signupApi(obj:any){
    transaction("post", "signup", obj, signupApiCallback);
  }
  ...
  return(
    <>
      ...
      >
      {/* <!-- Modal content --> */}
        <form onSubmit={(e)=>signUpClickHandler(e)} className="flex flex-col w-full h-full p-6 text-center bg-white rounded-3xl" autoComplete="none" >
          ...
          <span className="ps-1 text-red-500">{emailMsg}</span>
          </label>
          <input 
          ref={focusEmail} 
          ...
          <span className="ps-1 text-red-500">{nameMsg}</span>
          </label>
          <input 
          ref={focusName} 
          ...
          <span className="ps-1 text-red-500">{passwordMsg}</span>
          </label>
          <input 
          ref={focusPassword} 
          ...
          <span className="ps-1 text-red-500">{rePasswordMsg}</span>
          </label>
          <input 
          ref={focusRepassword} 
